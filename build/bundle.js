...
var app = (function () {
    ...
    const file$3 = "src\\pages\\Test.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 4, 0, 76);
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file$3, 7, 0, 133);
    			attr_dev(a1, "href", "#/another");
    			add_location(a1, file$3, 8, 0, 156);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src\\pages\\Pets.svelte";
    ...
    const file$1 = "src\\pages\\Kelly.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(meta, file$1, 1, 4, 19);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Test, Router, Pets, Kelly, routes });
    	return [routes];
    }
